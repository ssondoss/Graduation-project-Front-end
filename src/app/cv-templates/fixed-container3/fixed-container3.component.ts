...
@Component({
  selector: 'app-fixed-container3',
  templateUrl: './fixed-container3.component.html',
  styleUrls: ['./fixed-container3.component.scss'],
})
export class FixedContainer3Component implements OnInit {
  about = true;
  contact = false;
  cvData;
  id;
